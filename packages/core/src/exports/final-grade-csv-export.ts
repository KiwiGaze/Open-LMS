...
const csvHeaders = ['student_id', 'score', 'max_score', 'percent', 'letter_grade', 'computed_at'];
...
export const serializeCourseFinalGradesAsCsv = (grades: CourseFinalGradeContract[]): string => {
  const body = grades
